...
Generated by `/kb-sprint-tasks-plan` on 2026-05-21. All 10 tasks score 115/115 on the 115-point rubric.

- [`DESIGN-NAV-001-sticker-sheet-sessionslistscreen-header-session-row-workspace-section-.md`](./DESIGN-NAV-001-sticker-sheet-sessionslistscreen-header-session-row-workspace-section-.md) — frontend-designer · 90 min
- [`DESIGN-NAV-002-sticker-sheet-hostpickersheet-host-picker-bottom-sheet.md`](./DESIGN-NAV-002-sticker-sheet-hostpickersheet-host-picker-bottom-sheet.md) — frontend-designer · 45 min
- [`DESIGN-NAV-003-sticker-sheet-newchatsheet-workspace-picker-4-empty-states.md`](./DESIGN-NAV-003-sticker-sheet-newchatsheet-workspace-picker-4-empty-states.md) — frontend-designer · 60 min
- [`DESIGN-PLATF-003-iconography-spec-lucide-icon-set-for-chat-actions.md`](./DESIGN-PLATF-003-iconography-spec-lucide-icon-set-for-chat-actions.md) — frontend-designer · 30 min
- [`MOB-INFRA-001-install-chat-tree-runtime-dependencies-in-apps-mobile.md`](./MOB-INFRA-001-install-chat-tree-runtime-dependencies-in-apps-mobile.md) — react-native-ui-implementer · 60 min
- [`MOB-INFRA-002-configure-storybook-9-with-root-toggle-real-app-provider-stack-and-4-d.md`](./MOB-INFRA-002-configure-storybook-9-with-root-toggle-real-app-provider-stack-and-4-d.md) — react-native-ui-implementer · **240 min** (bumped from 180 to include provider-stack mirror + 4 design-system primitive stories)
- [`MOB-NAV-002-build-sessionrow-pure-component-with-status-icon-and-storybook-stories.md`](./MOB-NAV-002-build-sessionrow-pure-component-with-status-icon-and-storybook-stories.md) — react-native-ui-implementer · 120 min
- [`MOB-NAV-003-build-workspacesection-loadmorepill-subcomponents-with-stories.md`](./MOB-NAV-003-build-workspacesection-loadmorepill-subcomponents-with-stories.md) — react-native-ui-implementer · 180 min
- [`MOB-NAV-004-build-hostchip-newchatfab-sessionsearchbar-and-sessionsemptystate-comp.md`](./MOB-NAV-004-build-hostchip-newchatfab-sessionsearchbar-and-sessionsemptystate-comp.md) — react-native-ui-implementer · 180 min
- [`MOB-NAV-008-UI-build-hostpickersheet-pure-component-uc-nav-03-visual-no-data-wiring-w.md`](./MOB-NAV-008-UI-build-hostpickersheet-pure-component-uc-nav-03-visual-no-data-wiring-w.md) — react-native-ui-implementer · 150 min

### Recommended execution order (topological)

1. **DESIGN-PLATF-003** (icon spec — gates all icon decisions)
2. **DESIGN-NAV-001 / DESIGN-NAV-002 / DESIGN-NAV-003** (sticker sheets — gate the four NAV impl tasks)
3. **MOB-INFRA-001** (deps install — gates all RN/Storybook work)
4. **MOB-INFRA-002** (Storybook config + provider stack + primitive stories — gates every component story)
5. **MOB-NAV-002 / MOB-NAV-003 / MOB-NAV-004 / MOB-NAV-008-UI** (component builds in parallel)
