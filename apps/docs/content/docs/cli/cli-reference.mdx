...
<Command
	...
	options={[
		...
		{ flag: "--project <id>", description: "Filter to a specific project ID." },
		{ flag: "--search <query>", description: "Filter by workspace name (substring match)." },
	]}
	output={`Array<{
  id: string;
  name: string;
  ...
  hostName: string;
	...
	humanColumns={["NAME", "BRANCH", "PROJECT", "HOST", "ID"]}
	quiet="workspace IDs"
>
